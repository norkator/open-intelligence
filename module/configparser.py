...
def any_config(filename=os.getcwd() + '/config.ini', section='app'):
    parser = ConfigParser()
...
def super_resolution_config(filename=os.getcwd() + '/config.ini', section='superresolution'):
    parser = ConfigParser()
    parser.read(filename)
    config = {}
    if parser.has_section(section):
...
def face_recognition_config(filename=os.getcwd() + '/config.ini', section='facerecognition'):
    parser = ConfigParser()
    parser.read(filename)
    config = {}
    if parser.has_section(section):
